...
if __name__ == "__main__":
    ...
    parser.add_argument('--use_gta', '-g', dest='use_gta', action='store_true', help='Generate from GTA testset')
    ...
    parser.set_defaults(use_gta=False)
    ...
    _, test_set = get_vocoder_datasets(paths.data, 1, use_gta)
